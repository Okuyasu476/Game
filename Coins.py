...
BG_MUSIC = mixer.music.load(os.path.join("Assets/sounds", "flowey.mp3"))
...
class Dinosaur:
    ...
    def jump(self):
        ...
        self.hitbox = pygame.Rect(self.dino_rect.x + 12, self.dino_rect.y + 1, 33, 30)
...
class SmallCactus(Obstacle):
    def __init__(self, image):
        ...
        self.rect.y = 350
        self.hitbox = pygame.Rect(self.rect.x + 100, self.rect.y + 5, self.rect.width + 25, self.rect.height - 10)
...
class LargeCactus(Obstacle):
    def __init__(self, image):
        ...
        super().__init__(image, self.type)
        self.rect.y = 330
        self.hitbox = pygame.Rect(self.rect.x + 100, self.rect.y + 5, self.rect.width + 20, self.rect.height - 10)
...
class Bird(Obstacle):
    def __init__(self, image):
        ...
        self.rect.y = 280
        self.index = 0
        self.hitbox = pygame.Rect(self.rect.x + 10, self.rect.y + 10, 70, 60)
...
def menu(death_count):
    ...
    while run:
        ...
        # Title
        if death_count == 0:
            title_text = font.render("Dino Game", True, (0, 0, 0))
        else:
            title_text = font.render("Game Over", True, (255, 0, 0))
            score_text = button_font.render("Your Score: " + str(points), True, (0, 0, 0))
            SCREEN.blit(score_text, (SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 - 120))

        SCREEN.blit(title_text, (SCREEN_WIDTH // 2 - 100, SCREEN_HEIGHT // 2 - 200))
        ...
        # Dino image
        SCREEN.blit(RUNNING[0], (SCREEN_WIDTH // 2 - 25, SCREEN_HEIGHT // 2 - 270))
